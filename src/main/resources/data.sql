...
VALUES
    ...
    (2, 'Review shared workflow', 'Prepare the collaboration flow for later phases', 'TODO', DATEADD('DAY', 2, DATEADD('HOUR', 10, CURRENT_DATE)), 1, NULL, DATEADD('HOUR', 9, CURRENT_DATE), DATEADD('HOUR', 9, CURRENT_DATE), NULL),
